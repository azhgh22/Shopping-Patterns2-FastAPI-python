...
class TestReceipts:
    ...
    def test_should_get_receipt_by_id(self) -> None:
    ...
    def test_service_should_close_receipt(self, http: TestClient) -> None:
        receipt_list = [Receipt("1", "open", [], 0)]
        service = ReceiptService(ReceiptInMemoryRepository(receipt_list))
        service.close_receipt("1", "closed")
    ...
    def test_should_just_increase_quantity(self) -> None:
